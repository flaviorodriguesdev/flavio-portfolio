        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="flex gap-5 px-4 border-l border-neutral-800 pl-6">
              ...
              <a href="https://www.linkedin.com/in/flaviorodriguesdevv/" target="_blank" className="text-neutral-500 hover:text-white transition-all hover:scale-110"><FaLinkedin className="h-6 w-6" /></a>
            </div>
          </div>
        </motion.div>
      </section>
